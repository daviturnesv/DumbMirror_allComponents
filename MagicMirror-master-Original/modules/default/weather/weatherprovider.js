...
const WeatherProvider = Class.extend({
	...
	// This returns the latest Air Quality object (provider specific shape)
	airQuality () {
		return this.airQualityObject;
	},
	...
	// Set the air quality data and notify delegate if needed elsewhere
	setAirQuality (airQualityObject) {
		this.airQualityObject = airQualityObject;
	},
