...
module.exports = NodeHelper.create({
	...
	socketNotificationReceived: function(notification, payload) {
			...
			case MODULE_NOTIFICATIONS.stop_app:
				this.dialServer.stopCast();
				break;
				case MODULE_NOTIFICATIONS.resync: {
					const port = (this.currentConfig && this.currentConfig.port) || this.dialServer.config?.port;
					this.sendSocketNotification(MODULE_NOTIFICATIONS.start_dial, { port });
					break;
				}
			default:
				break;
